...
The methods related to the [Clipboard](/api-reference/clipboard) can now be found under the `Clipboard` namespace.
...
The methods and interfaces related to the [Storage](/api-reference/storage) can now be found under the `LocalStorage` namespace.
...
The main changes to the [Feedback](/api-reference/feedback) methods are related to the Toast:
...
The interfaces related to the [Keyboard](/api-reference/keyboard) can now be found under the `Keyboard` namespace.
...
The interfaces related to the [Color](/api-reference/user-interface/colors) can now be found under the `Color` namespace.
...
The interfaces and enumerations related to the [Image](/api-reference/user-interface/icons-and-images) can now be found under the `Image` namespace. `Icon` is still a top-level export.
