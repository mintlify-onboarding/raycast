...
<CardGroup cols={2}>
  <Card title="Store" icon="store">
    Search and install all published extensions
  </Card>
  <Card title="Create Extension" icon="square-dashed-circle-plus">
    Create new extensions from templates
  </Card>
  <Card title="Import Extension" icon="code">
    Import extensions from source code
  </Card>
  <Card title="Manage Extensions" icon="upload">
    List and edit your published extensions
  </Card>
</CardGroup>
