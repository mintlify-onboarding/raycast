...
Before you publish your extension, take a look at [how to prepare your extension](/basics/prepare-an-extension-for-store) for the Store. Making sure you follow the guidelines is the best way to help your extension pass the review.
...
<Info>
  `npm run build` validates your extension for distribution without publishing
  it to the store. Read more about it [here](/information/tools/cli#build).
</Info>
...
<Info>
  If someone contributes to your extension, running `npm run publish` will fail
  until you run
...
<Frame caption="Manage your extensions">
  <img src="/images/basics/basics-manage-extensions.png" />
</Frame>
