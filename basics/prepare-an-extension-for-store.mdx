...
![](/images/basics/good-subtitle.png)
...
![](/images/basics/categories-focus.png)
...
1. 1. Set up Window Capture in Advanced Preferences (Hotkey e.g.: `⌘⇧⌥+M`)

2. 2. Open the command

3. 3. Press the hotkey, remember to tick `Save to Metadata`
...
![](/images/basics/version-history.png)
...
![](/images/basics/required-preferences-2.png)
...
![](/images/basics/action-panel.png)
