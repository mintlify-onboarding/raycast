...
1. 1.  
Activate your extension in dev mode via `npm run dev` or via the VSCode command `Raycast: Start Development Mode`

2. 2.  
Start the VSCode command `Raycast: Attach Debugger`

3. 3.  
Set your breakpoint like in any other node.js base project
...
![](/images/basics/basics-unhandled-exception.png)
...
![](/images/basics/basics-react-developer-tools.png)
