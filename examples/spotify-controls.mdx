...
<Info>
  ...
  [here](https://github.com/raycast/extensions/tree/main/extensions/spotify-controls#readme).
...
<Frame caption="Example: Control the Spotify macOS app from Raycast">
  <img src="/images/examples/example-spotify-controls.png" />
</Frame>
