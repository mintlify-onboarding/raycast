...
<Frame caption="Create an Organization">
  <img src="/images/teams/teams-create-organization.png" />
</Frame>

<Info>
  You can use the Manage Organization command to edit your organization's
  information later.
</Info>
...
<Frame caption="Create Local Repository">
  <img src="/images/teams/teams-create-repository.png" />
</Frame>
...
<Frame caption="Build the Getting Started Extension">
  <img src="/images/teams/teams-develop-extension.png" />
</Frame>

<Info>
  See [Create Your First Extension](/basics/create-your-first-extension) for a
  more detailed guide on how to create an extension.
</Info>
...
<Frame caption="Publish the Getting Started Extension">
  <img src="/images/teams/teams-publish-extension.png" />
</Frame>
...
As a next step, follow [this guide](/teams/collaborate-on-private-extensions) to push your local repository to a source control system. This allows you to collaborate with your teammates on your extensions.
