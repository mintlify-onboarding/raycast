...
Hook which asks the AI to answer a prompt and returns the [AsyncState](/utilities/react-hooks/useai#asyncstate) corresponding to the execution of the query.
...
Returns an object with the [AsyncState](/utilities/react-hooks/useai#asyncstate) corresponding to the execution of the function as well as a couple of methods to manipulate it.

* `data`, `error`, `isLoading` \- see [AsyncState](/utilities/react-hooks/useai#asyncstate).
