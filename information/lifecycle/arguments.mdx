---
title: "Arguments"
description: "Raycast supports arguments for your commands so that users can enter values right from Root Search before opening the command."
---

![](/images/arguments.png)

Arguments are configured in the [manifest](/information/manifest#argument-properties) per command.

<Info>
-  **Maximum number of arguments:** 3 (if you have a use case that requires
  more, please let us know via feedback or in the [Slack
  community](https://www.raycast.com/community))
