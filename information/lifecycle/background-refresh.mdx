...
Add a new property `interval` to a command in the [manifest](/information/manifest#command-properties)
...
![](/images/background-refresh-error.png)
...
![](/images/background-refresh-preferences.png)
